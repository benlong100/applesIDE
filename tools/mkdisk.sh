...
# the emulator was holding. That is how three separate bugs came to be
# diagnosed against a binary that was not running, twice in one evening.
sleep 1
...
# check is an assumption about what the emulator did with its buffer.
